...
#     alpha_estimation.R v2.6 and portfolio_sorts.R v1.4. Full coverage
#     December 1994 -- February 2026 rather than the 1995--2023 cap. Affects
#     Tables 5, 7, and Figure 2 directly (Table 8 / Lipper breakdown inherits
#     the same panel). Cross-script consistency: descriptive_statistics.R's
#     main Table 2 and alpha_reporting.R's Tables 5-8 are now all built on
#     the same incubation-corrected panel.
#   - File deduplicated. Previous v1.0 on disk contained the full script body
#     twice back-to-back (lines 1-289 and 290-579 were identical); both
#     halves ran sequentially and the second overwrote the first. One clean
#     copy now, half the runtime.
#
...
#
# Requires (in session): panel_incubation with columns
