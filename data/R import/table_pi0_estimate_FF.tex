...
\sbox{\tabletempbox}{%
\footnotesize
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{12em}rrr>{\raggedright\arraybackslash}p{11em}}
\toprule
Metric & Estimate & $N$ & $\lambda$ & Interpretation\\
\midrule
$\hat{\pi}_0$: Proportion of True Zero-Alpha Active Funds & 76.3\% & 805 & 0.5 & Heterogeneous skill; majority zero-alpha\\
\bottomrule
\end{tabular}%
}
