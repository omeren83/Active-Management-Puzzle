...
\begin{tabular}[t]{lrrr>{\raggedleft\arraybackslash}p{15em}l}
\toprule
  & Percentile & Actual $t(\hat{\alpha})$ & Simulated Mean & Prob.\ Luck & Interpretation\\
\midrule
1% & 1 & -3.297 & -2.246 & 1.4\% & Worse than luck (significant)\\
5% & 5 & -2.437 & -1.463 & 0.1\% & Worse than luck (significant)\\
10% & 10 & -1.994 & -1.111 & 0.1\% & Worse than luck (significant)\\
50% & 50 & -0.472 & 0.014 & 1.4\% & Indistinguishable from luck\\
90% & 90 & 1.106 & 1.129 & 48.6\% & Consistent with zero-skill\\
95% & 95 & 1.559 & 1.481 & 63.5\% & Consistent with zero-skill\\
99% & 99 & 2.370 & 2.296 & 61.6\% & Consistent with zero-skill\\
\bottomrule
\end{tabular}
\begin{tablenotes}
